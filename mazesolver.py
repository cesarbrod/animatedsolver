...
class Maze:
    ...
    def display(self, path=None, visited=None):
        """Display the maze with optional path and visited nodes."""
...
class PathSolver:
    ...
    def bfs(self):
        ...
        all_visited = [self.maze.start]  # Track order of exploration
        nodes_explored = 0
    ...
    def a_star(self):
        ...
        visited = {self.maze.start: 0}  # position: g_score
        all_visited = [self.maze.start]  # Track order of exploration
        nodes_explored = 0
            ...
            if choice == '5':
                ...
                for name, path, nodes, elapsed, all_visited in results:
                    ...
                    if path:
                        ...
                        maze.display(path, visited_not_in_path)
                    else:
                        print("No path found!")
                        maze.display(None, all_visited)
